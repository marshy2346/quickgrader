...
class QJSValue(sip.simplewrapper):
    ...
    def callAsConstructor(self, args: typing.Any = ...) -> 'QJSValue': ...
    def callWithInstance(self, instance: typing.Union['QJSValue', 'QJSValue.SpecialValue', bool, int, float, str], args: typing.Any = ...) -> 'QJSValue': ...
    def call(self, args: typing.Any = ...) -> 'QJSValue': ...
...
class QQmlEngine(QJSEngine):
    ...
    def importPlugin(self, filePath: str, uri: str, errors: typing.Any) -> bool: ...
...
@typing.overload
def qmlRegisterSingletonType(a0: type, uri: str, major: int, minor: int, typeName: str, factory: typing.Callable[[], typing.Any]) -> int: ...

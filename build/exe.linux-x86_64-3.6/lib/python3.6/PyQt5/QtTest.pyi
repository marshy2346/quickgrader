...
class QTest(sip.simplewrapper):
    ...
    def waitForEvents(self) -> None: ...
    @typing.overload
    def mouseEvent(self, action: 'QTest.MouseAction', widget: QtWidgets.QWidget, button: QtCore.Qt.MouseButton, modifier: typing.Union[QtCore.Qt.KeyboardModifiers, QtCore.Qt.KeyboardModifier], pos: QtCore.QPoint, delay: int = ...) -> None: ...
    @typing.overload
    def mouseEvent(self, action: 'QTest.MouseAction', window: QtGui.QWindow, button: QtCore.Qt.MouseButton, modifier: typing.Union[QtCore.Qt.KeyboardModifiers, QtCore.Qt.KeyboardModifier], pos: QtCore.QPoint, delay: int = ...) -> None: ...
    @typing.overload

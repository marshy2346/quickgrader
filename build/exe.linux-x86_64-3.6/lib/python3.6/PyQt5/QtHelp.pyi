...
class QHelpEngineCore(QtCore.QObject):
    ...
    def linksForIdentifier(self, id: str) -> typing.Any: ...
    ...
    def filterAttributeSets(self, namespaceName: str) -> typing.Any: ...
...
class QHelpSearchEngine(QtCore.QObject):
    ...
    def searchResults(self, start: int, end: int) -> typing.Any: ...

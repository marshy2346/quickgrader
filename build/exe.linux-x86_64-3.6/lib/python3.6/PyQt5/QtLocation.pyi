...
class QGeoRouteRequest(sip.simplewrapper):
    ...
    def setRouteOptimization(self, optimization: 'QGeoRouteRequest.RouteOptimizations') -> None: ...
    def featureTypes(self) -> typing.Any: ...
    ...
    def setTravelModes(self, travelModes: 'QGeoRouteRequest.TravelModes') -> None: ...
    ...
    def setExcludeAreas(self, areas: typing.Any) -> None: ...
...
class QPlace(sip.simplewrapper):
    ...
    def contactDetails(self, contactType: str) -> typing.Any: ...
...
class QPlaceMatchRequest(sip.simplewrapper):
    ...
    def setParameters(self, parameters: typing.Dict[str, typing.Any]) -> None: ...
    def parameters(self) -> typing.Dict[str, typing.Any]: ...
    def setResults(self, results: typing.Any) -> None: ...

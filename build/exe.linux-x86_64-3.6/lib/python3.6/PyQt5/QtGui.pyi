...
class QTouchEvent(QInputEvent):
    ...
    @typing.overload
    def __init__(self, eventType: QtCore.QEvent.Type, device: typing.Optional['QTouchDevice'] = ..., modifiers: typing.Union[QtCore.Qt.KeyboardModifiers, QtCore.Qt.KeyboardModifier] = ..., touchPointStates: typing.Union[QtCore.Qt.TouchPointStates, QtCore.Qt.TouchPointState] = ..., touchPoints: typing.Any = ...) -> None: ...
    @typing.overload
...
class QGuiApplication(QtCore.QCoreApplication):
    ...
    @staticmethod
    def topLevelWindows() -> typing.Any: ...
    @staticmethod
    def allWindows() -> typing.Any: ...
...
class QKeySequence(sip.simplewrapper):
    ...
    @staticmethod
    def keyBindings(key: 'QKeySequence.StandardKey') -> typing.Any: ...
    @staticmethod
...
class QOpenGLDebugLogger(QtCore.QObject):
    ...
    def loggedMessages(self) -> typing.Any: ...
    @typing.overload
...
class QPainterPath(sip.simplewrapper):
    ...
    @typing.overload
    def toSubpathPolygons(self) -> typing.Any: ...
    @typing.overload
...
class QTextLayout(sip.simplewrapper):
    ...
    def glyphRuns(self, from_: int = ..., length: int = ...) -> typing.Any: ...

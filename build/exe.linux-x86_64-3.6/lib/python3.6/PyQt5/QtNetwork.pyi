...
class QNetworkCacheMetaData(sip.simplewrapper):
    ...
    def setRawHeaders(self, headers: typing.Any) -> None: ...
    def rawHeaders(self) -> typing.Any: ...
...
class QDnsLookup(QtCore.QObject):
    ...
    def abort(self) -> None: ...
    def textRecords(self) -> typing.Any: ...
    def serviceRecords(self) -> typing.Any: ...
    def pointerRecords(self) -> typing.List[QDnsDomainNameRecord]: ...
    def nameServerRecords(self) -> typing.List[QDnsDomainNameRecord]: ...
    def mailExchangeRecords(self) -> typing.Any: ...
    def hostAddressRecords(self) -> typing.Any: ...
    def canonicalNameRecords(self) -> typing.Any: ...
...
class QNetworkAccessManager(QtCore.QObject):
    ...
    def addStrictTransportSecurityHosts(self, knownHosts: typing.Any) -> None: ...
    ...
    def sslErrors(self, reply: 'QNetworkReply', errors: typing.Any) -> None: ...
...
class QNetworkConfigurationManager(QtCore.QObject):
    ...
    def allConfigurations(self, flags: typing.Union['QNetworkConfiguration.StateFlags', 'QNetworkConfiguration.StateFlag'] = ...) -> typing.Any: ...
...
class QSslConfiguration(sip.simplewrapper):
    ...
    def ellipticCurves(self) -> typing.Any: ...
    @staticmethod

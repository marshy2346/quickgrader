...
class QCamera(QMediaObject):
    ...
    def supportedViewfinderFrameRateRanges(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.Any: ...
    def supportedViewfinderResolutions(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.List[QtCore.QSize]: ...
    def supportedViewfinderSettings(self, settings: 'QCameraViewfinderSettings' = ...) -> typing.Any: ...
...
class QCameraFocus(QtCore.QObject):
    ...
    def focusZones(self) -> typing.Any: ...
...
class QCameraInfo(sip.simplewrapper):
    ...
    @staticmethod
    def availableCameras(position: QCamera.Position = ...) -> typing.Any: ...
    @staticmethod
...
class QMediaPlaylist(QtCore.QObject, QMediaBindableInterface):
    ...
    @typing.overload
    def addMedia(self, items: typing.Any) -> bool: ...
